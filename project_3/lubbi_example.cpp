 ...
 */
void lToFMapping(string &alphabet, int *R, int sizeOfR) {

//	string alphabetToWorkWith  = &alphabet;
	...
	int_vector & lolcats = * new int_vector;

	lolcats.push_back(1);
	lolcats.push_back(666);

	cout << "Vector element count: " << lolcats.size() << endl;

	cout << "Array size: " << (sizeof(*R)) << endl;
	cout << "Array element size: " << (sizeof(R[0])) << endl;
	cout << "Array element count: " << (sizeof(R)/sizeof(R[0])) << endl;
...
//		int *R_example = new int[L.length()];
		...
		lToFMapping(alphabet, R_example, L.length());
		cout << "R: " << endl;
